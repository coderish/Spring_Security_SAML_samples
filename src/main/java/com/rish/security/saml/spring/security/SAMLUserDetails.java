...
/**
 * Default Implementation of {@link UserDetails} for Spring Boot Security SAML.
 * This simple implementation hardly covers all security aspects since it's
 * mostly hardcoded. I.E. accounts are never locked, expired, or disabled, and
 * always eturn the same granted authority "ROLE_USER". Consider implementing
 * your own {@link UserDetails} and {@link SAMLUserDetailsService}.
 *
 */
public class SAMLUserDetails implements UserDetails {

	private static final long serialVersionUID = 3962530782349064932L;
	...
	public Map<String, String> getAttributes() {
		return samlCredential.getAttributes().stream().collect(Collectors.toMap(Attribute::getName, this::getString));
	}
